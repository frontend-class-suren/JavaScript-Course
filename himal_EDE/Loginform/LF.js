...
function btn1(){
    ...
    document.getElementById("btn1").style.backgroundImage="to right, #A842AF , #F0419C";
    document.getElementById("btn2").style.backgroundColor="white";
    
   
}

let codeOfSignup="<form action='#'><br><input type='text' placeholder='Name' style='height: 35px; width: 282px;padding-left: 10px;'required><br><input type='number' placeholder='Contact' style='height: 35px; width: 282px;padding-left: 10px;'required><br><input type='text' placeholder='Email Address' style='height: 35px; width: 282px;padding-left: 10px;'required><br><input type='password' placeholder='Password' style='height: 35px; width: 282px;padding-left: 10px;'required><br><button class='btn3'>Signup</button><br><br><p style='text-align: center;'>Already have an account?<span style='color: rgb(217, 71, 119) ;'>login</span></p></form>"
function btn2(){
    ...
    document.getElementById("btn2").style.backgroundImage="to right, #A842AF , #F0419C";
